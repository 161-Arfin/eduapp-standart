...
const FrontDetailComponent = ({
  ...
  const relationParts = [
    ...
    packageCapabilities.canManageRetention && row?.cabang_name
      ...
      <div className="group relative flex gap-x-5">
        ...
        <div className="grow pb-8 group-last:pb-0">
          ...
          {data?.user.usertypeId == 5 || data?.user.usertypeId == 1 ? (
                ...
                >
                  <div className="mb-0 flex justify-between items-center">
                    <div className="flex items-center gap-x-3">
                      <span className="size-8 flex justify-center items-center border border-gray-200 text-gray-500 rounded-lg p-0.5">
                        {/* Icon file */}
                        <svg
                          width="800px"
                          height="800px"
            ...
            // Jika superadmin
            row.instansi_id == data?.user.instansiId &&
              row.status_file_id == 0 &&
              row.user_id == data?.user.id ? (
              // Jika status file private (0), arsip miliknya dan instansinya maka tampilkan file
              <div className="mt-8">
                {/* <!-- Card File Arsip --> */}
                {row?.arsip_files?.map((item: any) => (
                  <div
            ...
            ) : row.status_file_id == 1 &&
              row.instansi_id == data?.user.instansiId ? (
              // Jika status file level instansi (1) dan instansinya maka tampilkan file
              <div className="mt-8">
                {/* <!-- Card File Arsip --> */}
                {row?.arsip_files?.map((item: any) => (
                  <div
            ...
            ) : row.status_file_id == 2 &&
              row.cabang_id == data?.user.cabangId ? (
              // Jika status file level cabang (2) dan cabangnya maka tampilkan file
              <div className="mt-8">
                {/* <!-- Card File Arsip --> */}
                {row?.arsip_files?.map((item: any) => (
                  <div
            ...
            ) : row.status_file_id == 3 ? (
              // Jika status file level divisi (3) dan divisinya maka tampilkan file
              <div className="mt-8">
                {/* <!-- Card File Arsip --> */}
                {row?.arsip_files?.map((item: any) => (
                  <div
            ...
            // Jika administrator
            row.status_file_id == 0 && row.user_id == data?.user.id ? (
              // Jika status file private (0) dan arsip miliknya maka tampilkan file
              <div className="mt-8">
                {/* <!-- Card File Arsip --> */}
                {row?.arsip_files?.map((item: any) => (
                  <div
              ...
              row.divisi_id == data?.user.divisiId ? (
              // Jika status file level divisi (3) dan divisinya maka tampilkan file
              <div className="mt-8">
                {/* <!-- Card File Arsip --> */}
                {row?.arsip_files?.map((item: any) => (
